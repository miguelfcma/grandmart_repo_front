...
export function CardOpcionesPerfilCliente() {
  ...
  return (
    <>
      ...
      <ListGroup>
        <ListGroup.Item>
          <Link to="/dashClient/perfil/datos" style={{width: '100%', textDecoration: 'none'}} className="separateIcon">
        ...
        <ListGroup.Item>
          <Link to="/dashClient/perfil/seguridad" style={{width: '100%', textDecoration: 'none'}} className="separateIcon">
            <div className="d-flex align-items-center justify-content-between">
        ...
        <ListGroup.Item>
          <Link to="/dashClient/perfil/tarjeta" style={{width: '100%', textDecoration: 'none'}} className="separateIcon">
            <div className="d-flex align-items-center justify-content-between">
