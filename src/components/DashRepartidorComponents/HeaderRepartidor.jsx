//Este archivvo solo es un encabezado fijo en el dashboard de repartidor, que mostrara todo el tiempo el logo del proyecto "Grandmart"

import { Link } from "react-router-dom";

export function HeaderRepartidor() {
  return (
    <div className="header">
      <div className="header-container">
        {/*Este logo a su vez funcionara para volver al inicio del dashboard con un clic*/}
        <Link to="/dashRepartidor">
